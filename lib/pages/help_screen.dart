...
class HelpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> mapButtonData = [
      ...
      {
        'image': 'assets/images/buttonicons/help_icon.png',
        'title': localization.helpTitle,
        'description': localization.helpDescription,
      },
      {
        'image': 'assets/images/buttonicons/language_icon.png',
        'title': localization.languageTitle,
        'description': localization.languageDescription,
      },
    ];
